    ...
    const navscript = () => {
        $('.menu-cate > li').mouseenter(() => {
            ...
            if (menuIdx !== null || menuIdx !== 0) {
                $('.menu-depth-detail > .w1280 > li').hide();
                $('.menu-depth-detail > .w1280 > li').eq(menuIdx).fadeIn(100);
            }
        });
        $('.subNav').mouseenter(() => {
            $('.menu-depth-detail > .w1280 > li').eq(menuIdx).hide();
        });
        $('.menu-depth-detail > .w1280 > li').mouseleave(() => {
            $('.menu-depth-detail > .w1280 > li').eq(menuIdx).hide();
        });
    };
                ...
                <div className="wrap">
                    ...
                    <ul className="menu menu-cate">
                        ...
                        {userInfo && userInfo.isStaff ? (
                            <li>
                                <Link to="/dashboard/app">매물등록</Link>
                            </li>
                        ) : null}
